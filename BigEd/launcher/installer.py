    ...
    def _build_header(self):
        ...
        if BANNER_PNG.exists():
            try:
                ...
                ctk.CTkLabel(hdr, text="B", font=FONT_TITLE, text_color="#b22222").pack(side="left", padx=(12, 8))
        else:
    ...
    def _step_build(self) -> str:
        ...
        cmds = [
            ...
            ["python", "-m", "PyInstaller", "--onefile",
             "--name", "UpdateHelper", "--icon", str(icon),
             str(src.parent.parent / "fleet" / "update_helper.py")],
            ["python", "-m", "PyInstaller", "--onefile", "--windowed",
