...
SKILL_MAP = {
    ...
    "lookup": "rag_query",
    "context": "rag_query",
    "test skill": "skill_test",
    "skill test": "skill_test",
    "promote": "skill_promote",
    "skill promote": "skill_promote",
    "skill learn": "skill_learn",
    "skill gaps": "skill_learn",
    "chain": "skill_chain",
    "pipeline": "skill_chain",
    "branch": "branch_manager",
    "product": "branch_manager",
    "evolve": "skill_evolve",
    "improve skill": "skill_evolve",
    "benchmark": "benchmark",
    "bench": "benchmark",
    "curriculum": "curriculum_update",
    "release": "product_release",
    "security review": "security_review",
    "security scan": "security_review",
