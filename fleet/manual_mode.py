...
class ManualModeEngine:
    ...
    scheduling, and run history. Includes Agent 4's governance additions:
    HITL approval gate, cost anomaly detection, and audit markdown output.
    """
    ...
    # ── Governance methods (Agent 4 additions) ────────────────────────────────
