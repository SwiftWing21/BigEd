...
class BridgeConfig:
    ...
    ml_tick_delay_min_ms: int = 200    # adaptive governor floor (ms)
    ml_tick_delay_max_ms: int = 1000   # adaptive governor ceiling (ms)
    ml_teacher_delay_ms: int = 750     # delay during LLM teacher-exclusive ticks
    ml_teacher_cooldown_ticks: int = 10  # ticks at teacher pace after queue drains
    ml_ups_window_size: int = 10       # sliding window samples for UPS measurement
