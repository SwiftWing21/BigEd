...
def _write_map_gen_settings(path: Path, biters: bool = False) -> None:
    ...
    settings = {
        ...
        "property_expression_names": {
            # 600% ore size — ~20M each of iron, copper, coal, stone near spawn
            "control-setting:iron-ore:size:multiplier": "6",
            "control-setting:copper-ore:size:multiplier": "6",
            "control-setting:coal:size:multiplier": "6",
            "control-setting:stone:size:multiplier": "6",
            ...
            "control-setting:stone:frequency:multiplier": "2",
            "control-setting:iron-ore:richness:multiplier": "3",
            "control-setting:copper-ore:richness:multiplier": "3",
            "control-setting:coal:richness:multiplier": "3",
            "control-setting:stone:richness:multiplier": "3",
        },
