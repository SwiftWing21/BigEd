...
def _clone_repo(repo: str, path: str = None) -> dict:
    """Clone a GitHub repo."""
    import subprocess
    if not repo:
...
def _push_changes(path: str, message: str) -> dict:
...
def _backup_fleet_state(repo: str = None) -> dict:
