...
def _git_status(repo_path: str, payload: dict) -> dict:
...
def _git_diff(repo_path: str, payload: dict) -> dict:
...
def _git_log(repo_path: str, payload: dict) -> dict:
...
def _git_branch(repo_path: str, payload: dict) -> dict:
...
def _git_commit(repo_path: str, payload: dict) -> dict:
...
def _git_stash(repo_path: str, payload: dict) -> dict:
...
def _git_checkout(repo_path: str, payload: dict) -> dict:
